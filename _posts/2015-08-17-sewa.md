...
![Sewa]({% flickrUrl sewa %}){: data-caption="Idyllic, isn't it?"}
...
![Houses of Sewa]({% flickrUrl tiny-houses-sewa %}){: data-caption="Imagine waking up to that view every morning..."}
...
![Kid]({% flickrUrl kid-happy %}){: data-caption="When I shot him for the first time, he wasn't too happy with the results. He suggested 'I press the button better' a second time. I think it worked."}


![Other People]({% flickrUrl ananya %}){: data-caption="No fancy baby food. Or diapers. Still happy as a clam."}
...
![Jaindra Singhji]({% flickrUrl mr-jaindra %}){: data-caption="Doesn't he look like an overgrown child?"}
