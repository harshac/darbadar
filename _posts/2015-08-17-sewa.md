...
![Sewa]({% flickrUrl sewa %}){: data-caption="Idyllic, isn't it?"}{:name="sewa"}
...
![Houses of Sewa]({% flickrUrl tiny-houses-sewa %}){: data-caption="Imagine waking up to that view every morning..."}{:name="tiny-houses-sewa"}
...
![Kid]({% flickrUrl kid-happy %}){: data-caption="When I shot him for the first time, he wasn't too happy with the results. He suggested 'I press the button better' a second time. I think it worked."}{:name="kid-happy"}


![Other People]({% flickrUrl ananya %}){: data-caption="No fancy baby food. Or diapers. Still happy as a clam."}{:name="ananya"}
...
![Jaindra Singhji]({% flickrUrl mr-jaindra %}){:data-caption="Doesn't he look like an overgrown child?"}{: name="mr-jaindra"}
