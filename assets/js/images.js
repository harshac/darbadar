...
var gallery = {
  ...
  loadThumbnails: function() {
    ...
    for (var i = 0, len = album.length; i < len; i++) {
      $(".carousel,.carousel-mini").append("<div class='thumbnail' style='background-image:url(" + album[i].t_src + "); background-size:cover' name='" + album[i].name + "'></div>");
    }
